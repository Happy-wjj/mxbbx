...
<link href='<c:url value="/bower_components/fullcalendar/dist/fullcalendar.print.css"/>' rel='stylesheet'
      media='print'>
...
<link href='<c:url value="/bower_components/bootstrap-tour/build/css/bootstrap-tour.min.css"/>'
      rel='stylesheet'>
