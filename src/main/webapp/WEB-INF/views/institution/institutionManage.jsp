					...
					<section class="vbox">
						<section class="scrollable padder">
							...
							<section class="panel panel-default">
								...
								<form action="<%= basePath %>institution/institutions"
									...
									<div class="row text-sm wrapper">
										...
										<div class="col-sm-10 m-b-xs">
											<div class="inline" style="margin-right:20px;">
												机构名称 <input type="text" id="keyword" name="keyword"
													class="input-sm form-control inline" style="width: 150px;"
													value="${keyword}" placeholder="请输入机构名称"
													data-rangelength="[4,15]">

												<button class="btn btn-sm btn-default">查询</button>
											</div>

											<a href="<%= basePath %>institution/toAdd"
												class="btn btn-dark btn-sm"> <i class="fa fa-plus"></i>
												新增组织机构
											</a> <a href="<%= basePath %>institution/toMerge"
												class="btn btn-default btn-sm"> <i
												class="fa fa-compress"></i> 合并组织机构
											</a>
										</div>
									</div>
															...
															<tr>
																...
																<td style="line-height: 30px;text-align: center;">
																	<c:if test="${inst.inststate != -1}">
																		<a
																			href="<%= basePath %>institution/toModify?instid=${inst.instid}"
