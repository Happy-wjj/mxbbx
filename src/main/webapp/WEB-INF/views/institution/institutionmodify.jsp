					...
					<section class="vbox">
						...
						<section class="scrollable padder">
							...
							<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
								...
								<li><a href="<%= basePath %>institution/institutions">
										机构管理 </a></li>
							...
							<form id="form" action="<%= basePath %>institution/modify"
								...
								<section class="panel panel-default">
									...
									<div class="panel-body">
										...
										<input type="hidden" name="instid"
											value="${institution.instid}"> <input type="hidden"
											name="mergedinstid" value="${institution.mergedinstid}">

										<div class="form-group">
											<label class="col-sm-4 control-label"> 机构名称<font
												color="red">（必填）</font>
											</label>
											<div class="col-sm-5">
												<input type="text" name="instname" class="form-control"
													data-required="true" placeholder="请输入机构名称..."
													value="${institution.instname}" data-rangelength="[4,15]"
													data-notblank="true"
													data-regexp="[\u4E00-\u9FA5\uF900-\uFA2D]+">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" name="postcode" class="form-control"
													data-maxlength="6" data-regexp="^[0-9][0-9]{5}$"
													data-type="number" placeholder="请输入邮编..."
													value="${institution.postcode}">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<select name="inststate" class="form-control m-b">
													<option value="1"
														<c:if test="${institution.inststate == 1 }">selected="selected"</c:if>>正常</option>
													<option value="0"
														<c:if test="${institution.inststate == 0 }">selected="selected"</c:if>>禁用</option>
												</select>
											</div>
										</div>
