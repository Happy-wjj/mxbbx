				...
				<section id="content">
					<section class="vbox">
						...
						<section class="scrollable padder">
							...
							<form id="form" action="<%= basePath %>institution/merge"
											...
											<div class="col-sm-3">
												<div class="checkbox">
													<label class="checkbox-custom"> <input
														type="checkbox" name="instid1"
														value="${institution.instid}"> <i
														class="fa fa-fw fa-square-o"></i> ${institution.instname}
													</label>
												</div>
											</div>
										</c:forEach>
								...
								<section class="panel panel-default">
									<header class="panel-heading font-bold"> 2.设置合并后的机构信息
									</header>
									<div class="panel-body">
										<h4>选择要将上面选中的这些机构合并为哪一个机构</h4>

										<c:forEach items="${validInstitution}" var="institution"
											varStatus="st">
											<div class="col-sm-3">
												<div class="radio">
													<label class="radio-custom"> <input type="radio"
														name="instid2" value="${institution.instid}"
