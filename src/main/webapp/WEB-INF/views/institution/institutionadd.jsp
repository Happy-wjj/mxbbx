				...
				<section id="content">
					<section class="vbox">
						...
						<section class="scrollable padder">
							...
							<form id="form" action="<%= basePath %>institution/add"
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" name="instaddr" class="form-control"
													data-rangelength="[4,20]" placeholder="请输入机构地址..."
													data-notblank="true">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" name="postcode" class="form-control"
													data-notblank="true" data-maxlength="6" data-type="number"
													data-regexp="^[0-9][0-9]{5}$" placeholder="请输入邮编...">
											</div>
										</div>
