					...
					<section class="vbox">
						<section class="scrollable padder">
							...
							<section class="panel panel-default">
								...
								<form action="<%= basePath %>workflow/deploys" method="post"
														...
														<c:forEach items="${page.list}" var="deployment">
															<tr>
																...
																<td style="line-height: 30px;text-align: center;">
																	<fmt:formatDate value="${deployment.deploymentTime}"
																		type="both" />
																</td>
																<td style="line-height: 30px;text-align: center;">
																	<a
																	href="<%= basePath %>workflow/removeDeploy?deploymentId=${deployment.id}"
