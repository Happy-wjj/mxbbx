					...
					<section class="vbox">
						<section class="scrollable padder">
							...
							<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
								...
								<li class="active">修改参合登记信息</li>
							</ul>

							<!-- 表格标题 -->
							<div class="m-b-md">
								<h2 class="m-b-none">修改参合登记信息</h2>
							</div>

							<form id="form" action="<%=basePath%>persinfo/Edit" method="post"
								...
								<br /> <input type="hidden" name="fid" value="${persinfo.id}">
								<!--增加/修改表单-->
								<section class="panel panel-default">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" name="persname"
													value="${persinfo.persname}" class="form-control" />
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" name="address"
													value="${persinfo.address}" class="form-control" />
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" name="tel" value="${persinfo.tel}"
													class="form-control" />
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" name="cardno" value="${persinfo.cardno}"
													class="form-control" />
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label class="col-sm-4 control-label">年龄 <font
												color="red">（必填）</font></label>
											<div class="col-sm-5">
												<input type="text" name="age" value="${persinfo.age}"
													class="form-control" />
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group date form_date col-sm-5">
												<input type="text" name="joinyear"
													value="${persinfo.joinyear}" class="form-control" /> <span
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" name="persnumber"
													value="${persinfo.persnumber}" class="form-control" />
											</div>
										</div>
									</div>
								</section>
