													...
													<c:when test="${!empty page.list}">
														<c:forEach items="${page.list}" var="fun">
															<tr>
																...
																<td style="line-height: 30px;"><c:choose>
																		<c:when
																			test="${fun.funurl != null && !empty fun.funurl}">${fun.funurl}</c:when>
																...
																<td style="line-height: 30px;text-align: center;">
																	<a
																	href="<%= basePath %>fun/toModify?funid=${fun.funid}"
																	class="btn btn-warning btn-sm">编辑</a> <c:choose>
																		<c:when test="${fun.funstate == 1}">
																			<a
																				href="<%= basePath %>fun/disable?funid=${fun.funid}"
																				class="btn btn-danger btn-sm"
																				onclick="return confirmDelete(this);">禁用</a>
																		</c:when>
																		<c:otherwise>
																			<a
																				href="<%= basePath %>fun/enable?funid=${fun.funid}"
																				class="btn btn-primary btn-sm">启用</a>
																		</c:otherwise>
																	</c:choose>
