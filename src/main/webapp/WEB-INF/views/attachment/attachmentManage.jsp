					...
					<section class="vbox">
						<section class="scrollable padder">
							...
							<section class="panel panel-default">
								...
								<form action="<%= basePath %>attachment/attachments"
									...
									<div class="row text-sm wrapper">
										...
										<div class="col-sm-10 m-b-xs">
											<div class="inline" style="margin-right:20px;">
												附件名称 <input type="text" id="keyword" name="keyword"
													class="input-sm form-control inline" style="width: 150px;"
													placeholder="请输入附件名称" value="${keyword}"
														...
														<c:forEach items="${page.list}" var="attachment">
															...
															<tr>
																...
																<td style="line-height: 30px;text-align: center;">
																	<fmt:formatDate value="${attachment.uploadtime}"
																		type="both" />
																</td>
																...
																<td style="line-height: 30px;text-align: center;">
																	<a
																	href="<%= basePath %>attachment/delete?attachmenId=${attachment.attachmentid}"
