					...
					<section class="vbox">
						...
						<section class="scrollable padder">
							...
							<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
								...
								<li><a href="<%= basePath %>page/Mbbill/list"> 慢性病症管理 </a>
								</li>
								<li class="active">添加慢性病症信息</li>
							</ul>

							<!-- 表格标题 -->
							<div class="m-b-md">
								<h2 class="m-b-none">添加慢性病症信息</h2>
							</div>

							<form id="form" action="<%= basePath %>page/Mbbill/add"
