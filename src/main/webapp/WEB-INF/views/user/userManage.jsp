					...
					<section class="vbox">
						<section class="scrollable padder">
							...
							<section class="panel panel-default">
								...
								<form action="<%= basePath %>user/users" method="post"
													...
													<c:when test="${!empty page.list}">
														<c:forEach items="${page.list}" var="user">
															<tr>
																...
																<td style="line-height: 30px;text-align: center;">
																	<a
																	href="<%= basePath %>user/toView?userid=${user.userid}"
																	class="btn btn-success btn-sm">查看</a> <a
																	href="<%= basePath %>user/toModify?userid=${user.userid}"
