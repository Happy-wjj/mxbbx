				...
				<section id="content">
					<section class="vbox">
						...
						<section class="scrollable padder">
							...
							<form id="form" action="<%= basePath %>user/modifyself"
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" name="job" class="form-control"
													data-required="true" value="${sessionScope.user.job}"
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" name="phone" class="form-control"
													data-type="phone" value="${sessionScope.user.phone}"
													placeholder="请输入手机号码...">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="email" name="email" class="form-control"
													data-type="email" value="${sessionScope.user.email}"
													placeholder="请输入邮箱...">
											</div>
										</div>
