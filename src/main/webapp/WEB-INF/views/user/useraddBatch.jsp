...
<body>
				...
				<section id="content">
					<section class="vbox">
						...
						<section class="scrollable padder">
							...
							<form id="form" action="<%= basePath %>user/addBatch"
								...
								<div>
									...
									<a href="<%= basePath %>user/downloadReadFile"
										class="btn btn-primary">下载使用说明</a> <a
										href="<%= basePath %>user/downloadExcel" class="btn btn-info">下载模板文件</a>
								</div>
								<br />

								<div class="alert alert-success">
									<h4>
										<b>如何批量导入用户信息？(请认真阅读后再操作！)</b>
									</h4>
									<p style="font-size: 16px;">
										第一步：您需要按照固定格式上传用户信息Excel电子表格文件（不支持Excel
										2007以上版本新格式，即xlsx格式！）。具体格式可以点击“<b>获得用户信息模板</b>”按钮下载模板。
									</p>
	...
	<script type="text/javascript"
		src="<%= basePath %>js/file-input/bootstrap-filestyle.min.js"></script>
