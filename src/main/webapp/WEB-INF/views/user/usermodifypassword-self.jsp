				...
				<section id="content">
					<section class="vbox">
						...
						<section class="scrollable padder">
							...
							<form id="form" action="<%= basePath %>user/modifyPassword"
								...
								<div>
									<a href="<%= basePath %>toWelcome"
										...
										class="fa  fa-chevron-left"></i>取消操作并返回首页</a>
								...
								<section class="panel panel-default">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											<label class="col-sm-4 control-label"> 原密码<font
												color="red">（必填）</font>
											</label>
											<div class="col-sm-5">
												<input type="password" name="oldPassword"
													class="form-control" placeholder="请输入原密码..."
													data-required="true"> <span> <font
													color="red"> 必须正确输入原密码才可以更改密码！<br />
														如果忘记原密码请联系系统管理员！
												</font>
												</span>
											</div>
										...
										<div class="form-group">
											<label class="col-sm-4 control-label"> 新密码<font
												color="red">（必填）</font>
											</label>
											<div class="col-sm-5">
												<input id="newPass" name="password" type="password"
										...
										<div class="form-group">
											<label class="col-sm-4 control-label"> 确认新密码<font
												color="red">（必填）</font>
											</label>
											<div class="col-sm-5">
												<input id="confirmNewPass" name="confirmPassword"
													type="password" class="form-control"
													placeholder="请再次输入新密码..." data-required="true"
													data-equalto="#newPass"> <span><font
													color="red">确认新密码必须和新密码保持一致！</font></span>
											</div>
										</div>
									</div>
								</section>
