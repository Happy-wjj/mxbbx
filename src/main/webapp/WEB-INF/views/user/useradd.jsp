								...
								<section class="panel panel-default">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											<label class="col-sm-4 control-label"> 用户名<font
												color="red">（必填）</font>
											</label>
											<div class="col-sm-5">
												<input type="text" name="loginname" class="form-control"
													data-required="true" data-rangelength="[4,30]"
													data-notblank="true" data-regexp="[A-Za-z0-9]+"
													placeholder="请输入用户名...">
											</div>
										</div>

										<div class="form-group">
											<label class="col-sm-4 control-label"> 密码<font
												color="red">（必填）</font>
											</label>
											<div class="col-sm-5">
												<input id="password" name="password" type="password"
													class="form-control" data-rangelength="[6,15]"
													data-notblank="true" data-required="true"
													placeholder="请输入密码...">
											</div>
										</div>

										<div class="form-group">
											<label class="col-sm-4 control-label"> 确认密码<font
												color="red">（必填）</font>
											</label>
											<div class="col-sm-5">
												<input id="confirmPassword" name="confirmPassword"
													...
													data-required="true" data-equalto="#password"
													placeholder="再输入一遍密码...">
											</div>
										</div>

										<div class="form-group">
											<label class="col-sm-4 control-label"> 用户真实姓名<font
												color="red">（必填）</font>
											</label>
											<div class="col-sm-5">
												<input type="text" name="usertruename" class="form-control"
													data-required="true"
													data-regexp="[\u4E00-\u9FA5\uF900-\uFA2D]+"
													data-notblank="true" placeholder="请输入用户真实姓名...">
											</div>
										</div>

										<div class="form-group">
											<label class="col-sm-4 control-label"> 职务<font
												color="red">（必填）</font>
											</label>
											<div class="col-sm-5">
												<input type="text" name="job" class="form-control"
													data-required="true"
													data-regexp="[\u4E00-\u9FA5\uF900-\uFA2D]+"
													data-notblank="true" placeholder="请输入用户的职务...">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="email" name="email" class="form-control"
													data-type="email" data-notblank="true"
													placeholder="请输入邮箱...">
											</div>
										</div>
