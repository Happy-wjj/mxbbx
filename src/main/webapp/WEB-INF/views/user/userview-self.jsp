						...
						<section class="scrollable padder">
							...
							<div>
								<a href="<%= basePath %>toWelcome"
									...
									class="fa  fa-chevron-left"></i>返回首页
								</a> <a href="<%= basePath %>user/toModifySelf"
									class="btn btn-warning btn-sm">修改个人信息</a> <a
									href="<%= basePath %>user/toPasswordModify"
									class="btn btn-danger btn-sm">修改我的密码</a>
							</div>
							<br />
								...
								<div class="panel-body">
									<form action="#" class="form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" class="form-control" readonly="readonly"
													value="${sessionScope.user.usertruename}"
													placeholder="用户真实姓名没加载出来">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<select class="form-control m-b" disabled="disabled">
													<option value="1"
														<c:if test="${sessionScope.user.userstate == 1}">selected="selected"</c:if>>正常</option>
													<option value="0"
														<c:if test="${sessionScope.user.userstate == 0}">selected="selected"</c:if>>禁用</option>
