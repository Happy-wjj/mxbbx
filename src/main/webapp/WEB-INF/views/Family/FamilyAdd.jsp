					...
					<section class="vbox">
						...
						<section class="scrollable padder">
							...
							<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
								...
								<li class="active">添加家庭档案信息</li>
							</ul>

							<!-- 表格标题 -->
							<div class="m-b-md">
								<h2 class="m-b-none">添加家庭档案信息</h2>
							</div>

							<form id="form" action="<%= basePath %>family/add" method="post"
								...
								<section class="panel panel-default">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											<label class="col-sm-4 control-label"> 县级编号<font
