					...
					<section class="vbox">
						...
						<section class="scrollable padder">
							...
							<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
								...
								<li><a href="<%= basePath %>role/roles"> 角色管理 </a></li>
							...
							<form id="form" action="<%= basePath %>role/modifyRole"
								...
								<section class="panel panel-default">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											<label class="col-sm-4 control-label"> 角色名称<font
												color="red">（必填）</font>
											</label>
											<div class="col-sm-5">
												<input type="text" name="rolename" class="form-control"
													data-required="true" data-rangelength="[4,15]"
													data-notblank="true" placeholder="请输入角色名称..."
													value="${role.rolename}"
													data-regexp="[\u4E00-\u9FA5\uF900-\uFA2D]+">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" name="roledesc" class="form-control"
													data-notblank="true" data-maxlength="300"
													placeholder="请输入角色描述..." value="${role.roledesc}">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<select name="rolestate" class="form-control m-b">
													<option value="1"
														<c:if test="${role.rolestate == 1}">selected="selected"</c:if>>正常</option>
													<option value="0"
														<c:if test="${role.rolestate == 0}">selected="selected"</c:if>>禁用</option>
												</select> <span><font color="red">一旦某个角色被禁用，则具有相应角色的用户将登录失败！</font></span>
											</div>
										</div>
									</div>
								</section>
