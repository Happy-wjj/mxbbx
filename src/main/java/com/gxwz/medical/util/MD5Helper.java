...
public class MD5Helper {  
    ...
    // �?新一次计算结果的16进制ASCII字符串表示，代表�?16个字符串形式的MD5�?  
    public String resultStr;  
  
    // �?新一次计算结果的2进制数组表示，一�?16个字节，代表�?128bit形式的MD5�?  
    ...
    public String getMD5ofStr(String in) {  
        ...
        for (int i = 0; i < 16; i++) {  
            resultStr += byteToHEX(digest[i]); // 将digest数组中的每个byte型数据转�?16进制形式的字符串  
        }  
        return resultStr;  
    }  
    ...
    private void md5Init() {  
        ...
        for (int i = 0; i < 16; i++)  
            digest[i] = 0;// 初始化digest数组元素�?0  
        return;  
    }  
  
    // 定义F G H I �?4个基�? ，即�?4个基本的MD5函数,进行�?单的位运�?  
